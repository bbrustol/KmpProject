...
import com.bbrustol.core.infrastructure.network.ServerStatusType.InternetConnectionProblems
...
object ApiHandler : KoinComponent {
    suspend inline fun <reified T : Any> handleApi(
        ...
        if (!networkChecker.isNetworkAvailable()) {
            return ApiException(serviceStatusType = InternetConnectionProblems)
        }
